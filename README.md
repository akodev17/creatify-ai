<p align="center">
  <img src="public/crunchycat-luna.gif" alt="Creatify AI Logo" />
</p>

# Creatify AI: Social Media Content Generator

Creatify AI is a powerful Next.js application that leverages AI to generate engaging content for various social media platforms. This project uses cutting-edge technologies to provide users with an intuitive interface for creating Twitter threads, Instagram captions, and LinkedIn posts.
